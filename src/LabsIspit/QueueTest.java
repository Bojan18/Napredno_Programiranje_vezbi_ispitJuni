...
class Queue <T> {
    ...
    public void enqueue( T element ) {
        ...
        Node<T> e = new Node<>(element, tail);
    }

    // todo
    public T dequeue() throws EmptyQueueException {
        //го отстранува елементот на почеток од редот и истиот го враќа, доколку редот е празен фрла исклучок EmptyQueueExceptio
        // redot : A B C
        // dequeue : A - ke vrati, B C ostanuvat
...
//        tail.setNext(head);
    ...
    public T peek() throws EmptyQueueException {
        //го враќа елементот на почетокот од редот (не ја менува листата), доколку редот е празен фрла исклучок EmptyQueueException
